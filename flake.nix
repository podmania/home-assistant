{
  ...
  outputs = { self, nixpkgs, nix2container, base }: let
    ...
    haosImg_x86_64 = pkgs.fetchurl {
      url = "https://github.com/home-assistant/operating-system/releases/download/17.3/haos_generic-x86-64-16.3.img.xz";
      hash = "sha256-aaaaaaaaaa";
      curlOpts = [ "--user-agent" "Mozilla/5.0" ];
    };

    haosXz_aarch64 = pkgs.fetchurl {
      url = "https://github.com/home-assistant/operating-system/releases/download/17.3/haos_generic-aarch64-16.3.qcow2.xz";
      hash = "sha256-bbbbbbbbbb";
      curlOpts = [ "--user-agent" "Mozilla/5.0" ];
    };
